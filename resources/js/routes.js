...
import CalculationManag from "./components/CalculationManag";
import MultireportAvg from "./components/MultireportAvg";
import ActuatorReport from "./components/ActuatorReport";
import DrainReport from "./components/DrainReport";
import DrainReportForMonth from "./components/DrainReportForMonth";
import PumpReport from "./components/PumpReport";
import AlarmReport from "./components/AlarmReport";
import MassMonth from "./components/MassMonth";
...
export const routes = [
    ...
    {
        path:'/calculationmanag',
        component: CalculationManag,
        name:'calculationmanag',
        meta: {
            requiresAuth: true
        },
    },
    ...
    {
        path:'/drainreportformonth',
        component: DrainReportForMonth,
        name:'drainreportformonth',
        meta: {
            requiresAuth: true
        },
    },
