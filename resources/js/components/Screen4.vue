<template>
    <div class="col-md-12" style="padding: 0px;">
        ...
        <div style="position: absolute; top: 753px; left: 1740px; display: inline-table;">
            <p>Bio ISO Filling</p>
        </div>
        <div style="position: absolute; top: 757px; left: 1589px; display: inline-table;">
            <p>Chilled Water</br>Pumps</p>
        </div>
        <div style="position: absolute; top: 760px; left: 1521px; display: inline-table;">
            <p style="color:black"><b>RVP</br>Water</br>Tanks</b></p>
        </div>
        <div :style="{'position': 'absolute','top': '677px','left': '1678px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'14px','color':'#BFFF00'}">FM-62</p>
            <!-- <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_4 }} m³/hr</p> -->
        </div>

        <div :style="{'position': 'absolute','top': '700px','left': '1676px','display':'inline-table','border':'1px solid'}">
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_62 }} m³/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_62).toFixed(2) }} m³</p>
        </div>
        <table class="table col-md-2"  style="position: absolute;top: 6px;left: 1570px;border: 1px solid;width: 270px;color: white;">
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span :style="{'color': 'white !important'}"> kg/hr </span>
                </td>
            </tr>
            <tr>
                <td>BIO</td>
        ...
        <div class="skill" :style="{'display': 'inline-flex','left': '731px','top': '30px'}">
        ...
        <div :style="{'position': 'absolute','top': '80px','left': '640px','display':'inline-table'}">
        ...
        <div :style="{'position': 'absolute','top': '34px','left': '640px','display':'inline-table'}">
        ...
        <div class="skill" :style="{'display': 'inline-flex','left': '875px','top': '30px'}">
            <div class="outer" :style="{'width': '18px','height': '84px'}">
        ...
        <div :style="{'position': 'absolute','top': '80px','left': '785px','display':'inline-table'}">
        ...
        <div :style="{'position': 'absolute','top': '34px','left': '785px','display':'inline-table'}">
        ...
        <div class="skill" :style="{'display': 'inline-flex','left': '1017px','top': '31px'}">
            <div class="outer" :style="{'width': '18px','height': '84px'}">
        ...
        <div :style="{'position': 'absolute','top': '80px','left': '930px','display':'inline-table'}">
        ...
        <div :style="{'position': 'absolute','top': '34px','left': '930px','display':'inline-table'}">
        ...
        <div class="skill" :style="{'display': 'inline-flex','left': '1158px','top': '32px'}">
            <div class="outer" :style="{'width': '18px','height': '84px'}">
        ...
        <div :style="{'position': 'absolute','top': '80px','left': '1070px','display':'inline-table'}">
        ...
        <div :style="{'position': 'absolute','top': '34px','left': '1070px','display':'inline-table'}">
        ...
        <div :style="{'position': 'absolute','top': '650px','left': '1805px','display':'inline-table'}">
            ...
            <span :style="{'background-color':'black','color':'#BFFF00','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}" >{{ dt_aio.dpl_8 }} in</span>
<!--            <span :style="{'background-color':'black','color':'#BFFF00','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}" v-else>NA in</span>-->
        ...
        <div class="skill" :style="{'display': 'inline-flex','left': '935px','top': '455px'}">
        ...
        <div :style="{'position': 'absolute','top': '495px','left': '865px','display':'inline-table'}">
...
<!--            <p :style="{'color': 'white'}">RTD-75</p>-->
            <p :style="{'background-color':'black','color':'white','font-weight':'600','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px','display':'none'}">NA &#8451;</p>
        </div>
...
<!--            <p :style="{'color': 'white'}">RTD-78</p>-->
        ...
        <div :style="{'position': 'absolute','top': '736px','left': '1066px','display':'inline-table'}">
...
<!--            <p :style="{'color': 'white'}">VG-1</p>-->
            <span :style="{'background-color':'black','color':'white','font-weight':'600','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}" v-if="dt_aio.vg_1 <= 0">0.00 tor</span>
            <span :style="{'background-color':'black','color':'white','font-weight':'600','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}" v-else>{{dt_aio.vg_1}} tor</span>
        </div>
       
        <div :style="{'position': 'absolute','top': '396px','left': '558px','display':'inline-table'}">
<!--            <p :style="{'color': 'white'}">VG-2</p>-->
            <span :style="{'background-color':'black','color':'white','font-weight':'600','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px','display':'none'}">NA</span>
        </div>
        <div :style="{'position': 'absolute','bottom': '66px','left': '142px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'14px','color':'#BFFF00'}">FM-9</p>
        </div>
        <div :style="{'position': 'absolute','bottom': '88px','left': '70px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-9</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_9 }} kg/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_9).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm9_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm9_temp }} &#8451;</p>
        </div>
          <div :style="{'position': 'absolute','bottom': '62px','left': '505px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','color':'#BFFF00','font-size':'14px'}">FM-12</p>
          </div>
        <div :style="{'position': 'absolute','bottom': '84px','left': '473px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-12</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_12 }} kg/hr</p>
           <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_12).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm12_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm12_temp }} &#8451;</p>
        </div>
         <div :style="{'position': 'absolute','bottom': '124px','left': '979px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','color':'#BFFF00','font-size':'14px'}">FM-13</p>
         </div>
        <div :style="{'position': 'absolute','bottom': '45px','left': '1024px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-13</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_13 }} kg/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_13).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm13_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm13_temp }} &#8451;</p>
        </div>
        <div :style="{'position': 'absolute','top': '460px','left': '1424px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'14px','color':'#BFFF00'}">FM-11</p>
        </div>
        <div :style="{'position': 'absolute','top': '359px','left': '1422px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-11</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_11 }} kg/hr</p>
           <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_11).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm11_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm1_temp }} &#8451;</p>
        </div>
         <div :style="{'position': 'absolute','top': '746px','left': '1861px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'14px','color':'#BFFF00'}">FM-22</p>
         </div>
        <div :style="{'position': 'absolute','top': '777px','left': '1807px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-22</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_22 }} kg/hr</p>
           <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_22).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm22_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm22_temp }} &#8451;</p>
        </div>
         <div :style="{'position': 'absolute','top': '423px','left': '61px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','color':'#BFFF00','font-size':'14px'}">FM-69</p>
         </div>
        <div :style="{'position': 'absolute','bottom': '492px','left': '22px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-10</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_10 }} kg/hr</p>
           <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_10).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm10_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm10_temp }} &#8451;</p>
        </div>
        <div :style="{'position': 'absolute','top': '193px','left': '1068px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','color':'#BFFF00'}">FM-8</p>
        </div>
        <div :style="{'position': 'absolute','top': '110px','left': '1202px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-8</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_8 }} kg/hr</p>
           <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_8).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm8_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm8_temp }} &#8451;</p>
        </div>
        <div :style="{'position': 'absolute','top': '674px','left': '596px','display':'inline-table'}">
        ...
        <div :style="{'position': 'absolute','top': '583px','left': '851px','display':'inline-table'}">
            <span :style="{'background-color':'black','color':'green','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}">00.00</span>
            <span :style="{'color': 'green','background-color':'black','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}">%</span><br>
            <img src="images/vg12.png" width="40">
            <p :style="{'color': 'white'}">BVM-6</p>
        </div>
        <div :style="{'position': 'absolute','top': '698px','left': '898px','display':'inline-table'}">
            <img src="images/vg2.png" width="40" v-if="valves_status.bvo_13 == 1 ">
            <img src="images/vg12.png" width="40" v-else>
            <p :style="{'color': 'white'}">BVO-13</p>
        </div>
        <div :style="{'position': 'absolute','top': '177px','left': '836px','display':'inline-table'}">
            ...
            <img src="images/vg1.png" width="25">
            <p :style="{'color': 'white !important','position':'absolute','top':'-11px'}">BVM-3</p>

        </div>
        <div :style="{'position': 'absolute','bottom': '313px','left': '1408px','display':'inline-table'}">
            <img src="images/vg1.png" width="25">
            <p :style="{'color': 'white !important','position':'absolute','top':'-11px','left':'18px'}">BVM-5</p>
            <span :style="{'background-color':'black','color':'#BFFF00','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}">00.00</span>
            <span :style="{'color': 'green','background-color':'black','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}">%</span>
        </div>
        <div :style="{'position': 'absolute','top': '135px','left': '643px','display':'inline-table'}">
            <span :style="{'color': 'white !important',}">  BOV-1</span>

            <img src="images/vg22.png" width="20" v-if="valves_status.bvo_1 == 1 ">
            <img src="images/vg1.png" width="20" v-else>
        </div>
        <div :style="{'position': 'absolute','top': '135px','left': '788px','display':'inline-table'}">
            <span :style="{'color': 'white !important',}">  BOV-2</span>

            <img src="images/vg22.png" width="20" v-if="valves_status.bvo_2 == 1 ">
            <img src="images/vg1.png" width="20" v-else>
        </div>
        <div :style="{'position': 'absolute','top': '135px','left': '931px','display':'inline-table'}">
            <span :style="{'color': 'white !important',}">  BOV-3</span>

            <img src="images/vg22.png" width="20" v-if="valves_status.bvo_3 == 1 ">
            <img src="images/vg1.png" width="20" v-else>
        </div>
        <div :style="{'position': 'absolute','top': '135px','left': '1072px','display':'inline-table'}">
            <span :style="{'color': 'white !important',}">  BOV-4</span>

            <img src="images/vg22.png" width="20" v-if="valves_status.bvo_4 == 1 ">
            <img src="images/vg1.png" width="20" v-else>
        </div>
        ...
        <div :style="{'position': 'absolute','top': '649px','left': '690px','display':'inline-table'}" v-for="pump in pump_interval">
          ...
          <div :style="{'position': 'absolute','top': '688px','left': '1606px','display':'inline-table'}">
          
            <img src="images/h22.png" width="30">
           
        </div>
        <div :style="{'position': 'absolute','top': '734px','left': '1606px','display':'inline-table'}" >
