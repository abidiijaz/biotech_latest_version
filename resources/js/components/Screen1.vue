<template>
    <div class="col-md-12" style="padding: 0px;">
        ...
        <div :style="{'position': 'absolute','top': '409px','left': '1032px','display':'inline-table'}">
            <img src="images/vg2.png" width="50" v-if="valves_status.bvo_12 == '1' ">
            <img src="images/vg12.png" width="50" v-else>
        </div>
         <div :style="{'position': 'absolute','top': '409px','left': '1245px','display':'inline-table'}">
            <img src="images/vg2.png" width="50" v-if="valves_status.bvo_13 == '1' ">
            <img src="images/vg12.png" width="50" v-else>
        </div>
         <div :style="{'position': 'absolute','top': '499px','left': '1879px','display':'inline-table'}">
            <a href="#" class="intro-banner-vdo-play-btn pinkBg" target="_blank" v-if="pump_status.gst == 0">
                <i class="glyphicon glyphicon-play whiteText" aria-hidden="true"></i>
                <span class="ripple pinkBg"></span>
                <span class="ripple pinkBg"></span>
                <span class="ripple pinkBg"></span>
            </a>
             <a href="#" class="intro-banner-vdo-play-btn2 pinkBg2" target="_blank" v-else>
                <i class="glyphicon glyphicon-play whiteText" aria-hidden="true"></i>
           ...
           <!-- <img src="images/green2.gif" style="width:35px;margin-top:6px;" v-else> -->
        </div>
          <!-- new added -->
            <div class="skill" :style="{'display': 'inline-flex','left': '1740px','top': '464px'}">
                <div class="outer" :style="{'width': '15px','height': '80px'}">
                    <div class="rdl_32_inner" data-progress="" v-if="parseInt(dt_aio.rdl_32) > parseInt(setpoint.rdl32_h)" style="background-color: #B70B0D !important;">
                        <div></div>
                    </div>
                    <div class="rdl_32_inner" data-progress="" v-else-if="parseInt(dt_aio.rdl_32) < parseInt(setpoint.rdl32_l)" style="background-color: #F4C103 !important;">
                        <div></div>
                    </div>
                    <div class="rdl_32_inner" data-progress="" v-else>
                        <div></div>
                    </div>
                </div>
                <p id="rdl_32" style="margin: auto; display: none;" > {{dt_aio.rdl_32}} </p>
            </div>
            <div :style="{'position': 'absolute','top': '503px','left': '1653px','display':'inline-table'}">
    ...
    <!--            <p :style="{'color': 'white','background-color':'black','text-align':'center'}">RDL-18</p>-->
                <span :style="{'background-color':'black','color':'#BFFF00','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}" v-if="dt_aio.rdl_32 <= -0.12">Error</span>
                <span :style="{'background-color':'black','color':'#BFFF00','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}" v-else>{{ dt_aio.rdl_32 }} in</span>
                <!--<p :style="{'color': 'white','background-color':'black','text-align':'center'}">VR-18</p>-->
                <p :style="{'background-color':'black','color':'#BFFF00','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}">{{dt_aio.vr_32}} m³</p>
            </div>
            <div :style="{'position': 'absolute','top': '460px','left': '1653px','display':'inline-table'}">
    <!--                <p :style="{'color': 'white','text-align':'center'}">RTD-34</p>-->
                ...
                <p :style="{'background-color':'black','color':'white','font-weight':'600','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}" >{{dt_aio.rtd_42}} &#8451;</p>
            </div>
        <!-- //////// -->
        <div :style="{'position': 'absolute','top': '197px','left': '1417px','display':'inline-table'}">
         ...
         <div :style="{'position': 'absolute','top': '733px','left': '200px','display':'inline-table'}">
           <!-- <p :style="{'color': 'white'}">VG-3</p> -->
            ...
            <p><span :style="{'background-color':'black','color':'#BFFF00','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px'}">{{dt_aio.pit_vol}} m³</span></p>
        </div>

        <div class="skill" :style="{'display': 'inline-flex','left': '398px','top': '126px'}">
            <div class="outer" :style="{'width': '17px','height': '121px'}">
                <div class="rdl_13_inner" data-progress="" v-if="parseInt(dt_aio.rdl_13) > parseInt(setpoint.rdl13_h)" style="background-color: #B70B0D !important;">
                    <div></div>
                </div>
...
<!--            <p :style="{'color': 'white'}">RTD-7</p>-->
        ...
        <div :style="{'position': 'absolute','top': '503px','left': '1778px','display':'inline-table'}">
<!--            <p :style="{'background-color':'#BDBFC0','color':'black','padding':'0px 3px','font-weight':'700','text-align':'center'}">GST#1</p>-->
<!--            <p :style="{'color': 'white','background-color':'black','text-align':'center'}">RDL-18</p>-->
        ...
        <div :style="{'position': 'absolute','top': '460px','left': '1778px','display':'inline-table'}">
<!--                <p :style="{'color': 'white','text-align':'center'}">RTD-34</p>-->
...
<!--            <p :style="{'color': 'white','text-align':'center','background':'black'}">RDL-5</p>-->
         ...
         <div :style="{'position': 'absolute','top': '287px','left': '1884px','display':'inline-table'}">
            <p :style="{'color': 'white','margin-bottom': '-3px','text-align':'center'}">FM-18</p>
         </div>
        <div :style="{'position': 'absolute','top': '310px','left': '1841px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','margin-bottom': '-3px','text-align':'center'}">FM-18</p> -->
            ...
            <!-- <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.ft_20 }} MT</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm20_den }} Kg/l</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm20_temp }} &#8451;</p> -->
        </div>
         <div :style="{'position': 'absolute','top': '206px','left': '1700px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center'}">FM-20</p>
         </div>
       <div :style="{'position': 'absolute','top': '229px','left': '1703px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-20</p> -->
            ...
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_20 }} m³/hr</p>
        </div>
...
<!--            <p :style="{'color': 'black','font-weight':'800','margin-bottom': '-5px'}">RTD-8</p>-->
         ...
         <div :style="{'position': 'absolute','top': '43px','left': '790px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'14px'}">FM-23</p>
         </div>
        <div :style="{'position': 'absolute','top': '66px','left': '775px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-23</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_23 }} kg/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_23).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm23_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm23_temp }} &#8451;</p>
        </div>
         <div :style="{'position': 'absolute','top': '36px','left': '669px','display':'inline-table'}">
            <span :style="{'color': 'white !important'}">FM-24</span>
         </div>
        <div :style="{'position': 'absolute','top': '58px','left': '651px','display':'inline-table'}">
            <!-- <span :style="{'color': 'white !important'}">FM-24</span> -->
<!--                <span :style="{'background-color':'black','color':'#BFFF00 !important','border-radius':'4px','padding':'0px 3px'}" v-if="fm.fm_24 <= -1.56">Error</span>-->
            <span :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid '}" >0.00 m³/hr</span>
        </div>
        <div :style="{'position': 'absolute','top': '301px','left': '1191px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center'}">FM-19</p>
        </div>
        <div :style="{'position': 'absolute','top': '325px','left': '1190px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-19</p> -->
         ...
         <div :style="{'position': 'absolute','top': '445px','left': '129px','display':'inline-table'}">
            <p :style="{'color': 'white','font-size':'14px'}">FM-25</p>
         </div>
        <div :style="{'position': 'absolute','top': '467px','left': '113px','display':'inline-table'}">
...
<!--            <span :style="{'background-color':'black','color':'#BFFF00 !important','border-radius':'4px','padding':'0px 3px'}" v-if="fm.fm_25 <= -0.93">Error</span>-->
    ...
    'left': '12px'}">B</p>
        ...
        <div :style="{'position': 'absolute','top': '798px','left': '111px','display':'inline-table'}">
            <img src="images/h111.png" width="25" v-if="pump_status.p810a == '1' ">
            <img src="images/h221.png" width="25" v-else>
        </div>
        <div :style="{'position': 'absolute','top': '798px','left': '155px','display':'inline-table'}">
            <img src="images/h111.png" width="25" v-if="pump_status.p810b == '1' ">
            <img src="images/h221.png" width="25" v-else>
        </div>
        <div :style="{'position': 'absolute','top': '798px','left': '198px','display':'inline-table'}">
            <img src="images/h111.png" width="25" v-if="pump_status.p810c == '1' ">
            <img src="images/h221.png" width="25" v-else>
        </div>
        <div :style="{'position': 'absolute','top': '798px','left': '247px','display':'inline-table'}" v-for="pump in pump_interval">
            <img src="images/h111.png" width="25" v-if="pump.sp_status == '1' ">
            <img src="images/h221.png" width="25" v-else>
        </div>
         <div :style="{'position': 'absolute','top': '722px','left': '1297px','display':'inline-table'}">
            <img src="images/vg22.png" width="25" v-if="valves_status.bvo_8 == 1 ">
            <img src="images/vg1.png" width="25" v-else>
            <span :style="{'color': 'white !important'}">  BOV-8</span>
        </div>
        <div :style="{'position': 'absolute','top': '722px','left': '1451px','display':'inline-table'}">
            <img src="images/vg22.png" width="25" v-if="valves_status.bvo_9 == 1 ">
            <img src="images/vg1.png" width="25" v-else>
            <span :style="{'color': 'white !important'}">  BOV-9</span>
        </div>
        <div :style="{'position': 'absolute','top': '722px','left': '1607px','display':'inline-table'}">
            <img src="images/vg22.png" width="25" v-if="valves_status.bvo_10 == 1 ">
            <img src="images/vg1.png" width="25" v-else>
        ...
        getData() {
            ...
            screen1(token)
                .then((res)=>{
                    ...
                    this.pump_status = res.pump_status
                    this.valves_status = res.valves_status
                    this.showbar();
                    console.log(this.pump_status.p810a)
        ...
        showbar(){
            $(document).ready(function() {
                ...
                $('.rdl_27_inner').css('height', add_rld_27 + 'px');
                 ////////////////////////
                var rdl_32 = $("#rdl_32").text();
                var data32 = (80 / 315) * parseInt(rdl_32);
                if (data32 >= 80) {
                    data32 = 80
                }
                var add_rld_32 = data32;
                $('.rdl_32_inner').css('height', add_rld_32 + 'px');
            })
        }
    },
    computed: {
...
.pinkBg {
    ...
    background-image: linear-gradient(90deg, #FF0505, #FF0505);
}
...
.pinkBg2 {
    background-color: #0c9100!important;
    background-image: linear-gradient(90deg, #0c9100, #0c9100);
}
