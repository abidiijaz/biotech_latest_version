...
<!--            <p :style="{'color': 'white','background-color':'black','margin-bottom':'-5px','text-align':'center'}">DPL-2</p>-->
        ...
        <!-- <div :style="{'position': 'absolute','top': '416px','left': '649px','display':'inline-table'}">
         ...
         <div :style="{'position': 'absolute','top': '728px','left': '41px','display':'inline-table'}">
            <p :style="{'color': 'white','margin-bottom':'5px','text-align':'center','font-size':'14px'}">FM-14</p>
         </div>
        <div :style="{'position': 'absolute','top': '774px','left': '17px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','margin-bottom':'5px','text-align':'center','font-size':'14px'}">FM-14</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_14 }} kg/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{parseFloat(dt_aio.ft_14).toFixed(2)}} Kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm14_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm14_temp }} &#8451;</p>
<!--            <p>Total Flow</p>-->
<!--            <p :style="{'color':'#BFFF00','margin-bottom': '12px','background-color':'black'}">00.00  &#13221;</p>-->
        </div>
         <div :style="{'position': 'absolute','top': '628px','left': '1071px','display':'inline-table'}">
            <p :style="{'color': 'white','margin-bottom':'5px','text-align':'center','font-size':'14px'}">FM-17</p>
         </div>
        <div :style="{'position': 'absolute','top': '650px','left': '1050px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','margin-bottom':'5px','text-align':'center','font-size':'14px'}">FM-17</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_17 }} kg/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_17).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm17_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm17_temp }} &#8451;</p>
<!--            <p>Total Flow</p>-->
<!--            <p :style="{'color':'#BFFF00','margin-bottom': '12px','background-color':'black'}">00.00  &#13221;</p>-->
        </div>
        <div :style="{'position': 'absolute','top': '513px','left': '1389px','display':'inline-table','border':'1px solid'}">
<!--            <p>Total Flow</p>-->
<!--            <p :style="{'color':'#BFFF00','background-color':'black'}">00.00  &#13221;</p>-->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_7 }} kg/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_7).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm7_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm7_temp }} &#8451;</p>
            
        </div>
        <div :style="{'position': 'absolute','top': '624px','left': '1447px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'14px'}">FM-7</p>
        </div>
        <div :style="{'position': 'absolute','top': '570px','left': '1014px','display':'inline-table'}">
            ...
            <span :style="{'background-color':'black','color':'#BFFF00','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px','display':'none'}">NA</span>
        </div>
        <div :style="{'position': 'absolute','top': '619px','left': '976px','display':'inline-table'}">
           <img src="images/indicator-off.gif" style="width:35px;" v-if="valvel_status.fs_1 == 0">
           <img src="images/green2.gif" style="width:35px;" v-else>
        </div>
         <div :style="{'position': 'absolute','top': '637px','left': '1208px','display':'inline-table','border':'1px solid'}">
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_16 }} m³/hr</p>
            <!-- <p :style="{'color': 'white','text-align':'center','font-size':'14px'}">FM-16</p> -->
         </div>
        <div :style="{'position': 'absolute','top': '664px','left': '1228px','display':'inline-table'}">
            <!-- <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_16 }} m³/hr</p> -->
            <p :style="{'color': 'white','text-align':'center','font-size':'14px'}">FM-16</p>
        ...
        <div :style="{'position': 'absolute','top': '460px','left': '1726px','display':'inline-table','border':'1px solid','background-color':'black'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'14px'}">FM-45</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_45 }} kg/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_45).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm45_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm45_temp }} &#8451;</p>
        </div>
         <div :style="{'position': 'absolute','top': '693px','left': '1309px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'14px'}">FM-15</p>
         </div>
        <div :style="{'position': 'absolute','top': '731px','left': '1275px','display':'inline-table','border':'1px solid'}">
            <!-- <p :style="{'color': 'white','text-align':'center','font-size':'14px'}">FM-15</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_15 }} kg/hr</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ parseFloat(dt_aio.ft_15).toFixed(2) }} kg</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm15_den }} Kg/dm³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm15_temp }} &#8451;</p>
        </div>
        ...
        <div :style="{'position': 'absolute','top': '244px','left': '1688px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'13px'}">FM-18</p>
        </div>
        <div :style="{'position': 'absolute','top': '174px','left': '1687px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'13px'}">FM-19</p>
        </div>
        <div :style="{'position': 'absolute','top': '116px','left': '1692px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'13px'}">FM-21</p>
        </div>
        <div :style="{'position': 'absolute','top': '34px','left': '1693px','display':'inline-table'}">
            <p :style="{'color': 'white','text-align':'center','font-size':'13px'}">FM-20</p>
        </div>
        
        <div :style="{'position': 'absolute','top': '273px','left': '1670px','display':'inline-table','border':'1px solid'}">
<!--            <p>Total Flow: <span :style="{'color':'#BFFF00','background-color':'black'}">00.00  &#13221;</span></p>-->

            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-18</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_18 }} MT/hr</p>
            <!-- <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.ft_18 }} ton</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.den_18 }} Kg/m³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.temp_18 }} &#8451;</p> -->

        </div>
        <div :style="{'position': 'absolute','top': '204px','left': '1670px','display':'inline-table','border':'1px solid'}">
<!--            <p style="margin-bottom: -8px;">Total Flow: <span :style="{'color':'#BFFF00','background-color':'black'}">00.00  &#13221;</span></p>-->
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-19</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_19 }} m³/hr</p>
            <!-- <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_19 }} ton</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_19 }} Kg/m³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_19 }} &#8451;</p> -->
        ...
        <div :style="{'position': 'absolute','top': '64px','left': '1670px','display':'inline-table','border':'1px solid'}">
<!--            <p>Total Flow: <span :style="{'color':'#BFFF00','background-color':'black'  }">00.00  &#13221;</span></p>-->
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-20</p> -->
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_20 }} MT/hr</p>
            <!-- <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.ft_20 }} ton</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.den_20 }} Kg/m³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.temp_20 }} &#8451;</p> -->

        </div>
        <div :style="{'position': 'absolute','top': '145px','left': '1670px','display':'inline-table','border':'1px solid'}">
<!--            <p>Total Flow: <span :style="{'color':'#BFFF00','background-color':'black'}">00.00  &#13221;</span></p>-->
            <!-- <p :style="{'color': 'white','text-align':'center'}">FM-21</p> -->
             <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.fm_21 }} MT/hr</p>
            <!-- <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.ft_21 }} ton</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.den_21 }} Kg/m³</p>
            <p :style="{'background-color':'black','color':'#BFFF00','border-radius':'4px','padding':'0px 3px','border':'1px solid yellow'}">{{ dt_aio.temp_21 }} &#8451;</p> -->
...
<!--            <p :style="{'color': 'white'}">RTD-95</p>-->
            ...
            <p :style="{'background-color':'black','color':'white','font-weight':'600','border':'0.1px solid yellow','border-radius':'4px','padding':'0px 3px','display':'none'}" v-else>NA  &#8451;</p>
        </div>
        ...
        getData() {
            ...
            screen2(token)
                .then((res)=>{
                    ...
                    this.valvel_status = res.valves_status
                    this.showbar();
                })
                .catch((err)=>{
                    console.log(err)
