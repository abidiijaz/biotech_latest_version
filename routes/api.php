...
Route::group(['middleware'=>['auth:sanctum']], function () {
    ...
    Route::post('/cataltst_cal', [Screen3Controller::class, 'CataltstCal']);    
    Route::get('/show_cataltst', [Screen3Controller::class, 'ShowCataltst']);    
    Route::post('/show_actuatorreport', [Screen3Controller::class, 'ActuatorReport']); 
    Route::post('/alarmshow', [Screen3Controller::class, 'AlarmShow']);

    Route::post('/show_drainreport', [Screen3Controller::class, 'showDrainReport']);   
    Route::post('/onoff_pumpreport', [Screen3Controller::class, 'OnOffPumpReport']);
    Route::match(['get','post'],'/massmonth', [Screen1Controller::class, 'MassMonth']);
    
});
                                                                                                                        
Route::post('/show_drainreportformonth', [Screen3Controller::class, 'showDrainReportForMonth']);
